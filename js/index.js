...
const funNSunh4 = d.querySelector(
	"section.content-pick > div:nth-child(1) > h4"
);
const mtnExcrsn = d.querySelector(
	"section.content-pick > div:nth-child(2) > h4"
);
const isLandgetAway = d.querySelector(
	"section.content-pick > div:nth-child(3) > h4"
);
...
boat.addEventListener("drag/drop", (e) => {
	boat.style.border = "30px solid pink";
});
funNSunh4.addEventListener("click", (e) => {
	funNSunh4.style.border = "30px solid red";
	e.stopPropagation();
});

boat.addEventListener("dblclick", (e) => {
	boat.style.border = "30px solid pink";
});
funNSunh4.addEventListener("wheel", (e) => {
	funNSunh4.style.color = " red";
});

mtnExcrsn.addEventListener("mouseover", (e) => {
	mtnExcrsn.style.color = "purple";
	event.stopPropagation();
});
navLinks.addEventListener("focus", (e) => {
	mtnExcrsn.style.opacity = ".50";
});

isLandgetAway.addEventListener("resize", (e) => {
	isLandgetAway.style.width = "30%";
});
isLandgetAway.addEventListener("drag/drop", (e) => {
	isLandgetAway.style.color = "redorange";
});
contentpick.addEventListener("mouseover", (e) => {
	contentpick.style.border = "double chartreuse 10px";
});
contentpick.addEventListener("dblclick", (e) => {
	contentpick.style.border = "solid chartreuse 50px";
});
let btn1 = document.querySelector(
	"body > div > section.content-pick > div:nth-child(3) > div"
);
let btn1Container = document.querySelector(
	"body > div > section.content-pick > div:nth-child(3)"
);
...
let sectionTitle6 = document.querySelector(
	"body > div > section.content-section.inverse-content > div.text-content > p:nth-child(2)"
);

let funImg7 = document.querySelector(
	"body > div > section.content-section.inverse-content > div.img-content > img"
);

let destinationImg8 = document.querySelector(
	"body > div > section.content-destination > img"
);

let btn2_9 = document.querySelector(
	"body > div > section.content-pick > div:nth-child(1)"
);

let btmMtnExcrsn10 = document.querySelector(
	"body > div > section.content-pick > div:nth-child(2) > h4.main-navigation"
);
let h2Letsgo11 = document.querySelector(
	"body > div > section:nth-child(2) > div.text-content > h2"
);
...
h2_4.addEventListener("mousemove", (event) => {
	sectionTitle6.style =
		'font-size:Math.floor((Math.random() * 8) + 3)+"px"; position: inherit;';
});
